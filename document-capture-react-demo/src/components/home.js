...
class Home extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            currentTab: 0,
            documentType: CONSTANT.DOCUMENT_TYPE.IDENTITY_CARD,
            sdkCapturedDocument: '',
            apiCapturedDocument: '',
            showLoader: false
        };
    ...
    renderDocumentCaptureSdk() {
        ...
        var firstTitle = 'Front of Identity Card',
        ...
        if (this.state.currentTab == 2) {
            return (
                <div className="tab submitFormFields">
                    ...
                    {this.state.apiCapturedDocument.birth_date !== undefined &&
                        (
                    ...
                    {(this.state.apiCapturedDocument.issue_date !== undefined) &&
                        (
                    ...
                    {(this.state.apiCapturedDocument.nationality !== undefined) &&
                        (
                            <p>
                                Nationality
