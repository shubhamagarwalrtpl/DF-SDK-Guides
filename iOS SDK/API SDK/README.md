...
|------------------------------------------|----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|createUserToken                              |This method is used to authenticate the user from server.                                     |Object of CreateTokenRequestModel class. <br> eg: CreateTokenRequestModel(token: "Token", channel: "Channel", referenceNumber: "referenceNumber", typeOfRequest: "requestype") 
