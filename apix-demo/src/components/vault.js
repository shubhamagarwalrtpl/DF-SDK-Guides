...
class Vault extends Component {
    ...
    getUserAssetList() {
        ...
        const userAssets = this.apiServer.getAssets({'apixAuthToken': this.state.apixAuthToken});
    ...
    getSharedAssetList() {
        ...
        const userAssets = this.apiServer.getSharedAssets({'apixAuthToken': this.state.apixAuthToken});
        userAssets.then((data) => {
            this.setState({
                showLoader: false
            });
    ...
    getOrganisationAssetRequestList() {
        ...
        const userAssets = this.apiServer.organisationAssetRequest({'apixAuthToken': this.state.apixAuthToken});
        userAssets.then((data) => {
            this.setState({
                showLoader: false
            });
    ...
    getOrganisationAllAssetRequestList() {
        ...
        const userAssets = this.apiServer.organisationAllAssetRequest({'apixAuthToken': this.state.apixAuthToken});
        userAssets.then((data) => {
            this.setState({
                showLoader: false
            });
    ...
    getUploadAssetRequestList() {
        ...
        const userUploadAssetsRequestRes = this.apiServer.uploadAssetRequest({'apixAuthToken': this.state.apixAuthToken});
    ...
    vaultAction(type, data) {
        ...
        if (type && data) {
            if (type.toLowerCase() === CONSTANT.VAULT_TYPE.ASSET_EDIT.toLowerCase()) {
                ...
                data['apixAuthToken'] = this.state.apixAuthToken;
                this.setState({
                    showLoader: true
                });
