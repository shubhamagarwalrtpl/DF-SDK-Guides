            ...
            <Router>
                <div className="header-main">
                    <ul className="header-nav">
                        ...
                        {/* <li>
                            <NavLink to="/dc" exact>Selfie Upload</NavLink>
                        </li> */}
                        <li>
                            <NavLink to="/video" exact>Video</NavLink>
                        </li>
                        {/* <li>
                            <NavLink to="/get-ocr" exact>Document Capture</NavLink>
                        </li> */}
                        {/* <li>
                    ...
                    <Route exact path="/get-ocr" render={() => <DocumentCapture logout={this.logoutHandler} />} />
                    <Route exact path="/dc" render={() => <Dc />} />
                    {/* <Route exact path="/capture" render={() => <ScreenCapture logout={this.logoutHandler} />} /> */}
                    {this.state.login &&
                        <div className="login-detail">
                            <span>Welcome {this.state.login.name}</span>
                            <a className="logout" onClick={this.logoutHandler}>Logout</a>
                        </div>
                    }
                </div>
            </Router>
